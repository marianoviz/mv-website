...
description: |
  Here, I explore the variables protein, carbohydrate, fat, and energy content in three different food groups (Beef Products, Pork Products, and Poultry Products) by performing a Principal Components Analysis (PCA) and reflecting this information on a biplot.
author:
  - name: Mariano Viz
    url: {}
date: 03-14-2021
...
nutrients_data <- read_csv(here("_posts", "2021-03-14-pca", "data", "usda_nutrients.csv")) %>% 
  clean_names()
